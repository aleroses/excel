...
- **Contenido:** Puedes escribir diferentes tipos de datos en una celda, como texto ("Hola"), números (123), fechas (12/08/2024), o fórmulas (=A1+B1).
...
Estos métodos te permiten seleccionar filas y columnas de manera precisa, ya sean adyacentes o no.
...
- **Cortar y pegar:** Selecciona las celdas que deseas mover, presiona **Ctrl + X** para cortarlas, luego selecciona la nueva ubicación y presiona **Ctrl + V** para pegarlas.
...
- **Ctrl + Flechas de dirección:** Moverse al borde de la región de datos actual.
- **Ctrl + Shift + Flechas de dirección:** Seleccionar hasta el final de la región de datos en una dirección.
- **Shift + Espacio:** Seleccionar la fila completa.
- **Ctrl + Espacio:** Seleccionar la columna completa.
- **Ctrl + Inicio:** Ir a la celda A1.
- **Ctrl + Fin:** Ir a la última celda usada del documento.
- **Ctrl + "+":** Añadir una fila (antes debes seleccionar una celda).
- **Ctrl + "-":** Eliminar una fila (antes debes seleccionar una celda o toda la fila).
...
- **Ctrl + Enter:** Llenar las celdas seleccionadas con la entrada actual.
- **F2:** Editar la celda activa.
  
### Formato

- **Ctrl + B:** Aplicar o quitar negrita.
- **Ctrl + I:** Aplicar o quitar cursiva.
- **Ctrl + U:** Aplicar o quitar subrayado.
- **Alt + Enter:** Insertar un salto de línea dentro de una celda.
- **Ctrl + 1:** Abrir el cuadro de diálogo "Formato de celdas".

### Fórmulas

- **Alt + =:** Insertar la función SUMA.
- **Ctrl + Shift + Enter:** Introducir una fórmula como una fórmula matricial (para Excel antes de la versión 365).
- **F4:** Repetir la última acción de "Pegar", o fijar celdas en referencias absolutas ($A$1).
- **Shift + F3:** Insertar una función desde el cuadro de diálogo "Insertar función".

### Gestión de hojas de cálculo

- **Ctrl + Page Up / Page Down:** Navegar entre las hojas del libro.
- **Shift + F11:** Insertar una nueva hoja.
- **Alt + H + O + R:** Renombrar la hoja actual.
- **Ctrl + N**: Crear un nuevo libro u hoja de cálculo.

### Vista y control

- **Ctrl + F:** Abrir el cuadro de diálogo "Buscar".
- **Ctrl + H:** Abrir el cuadro de diálogo "Reemplazar".
- **Ctrl + P:** Abrir la ventana de impresión.
- **Ctrl + S:** Guardar el archivo actual.
- **F12:** Guardar como.
- **Ctrl + F1:** Ocultar o mostrar la cinta de opciones.

### Gestión de archivos o documentos
